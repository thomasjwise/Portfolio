...
From this, there is now, three individual datasets which contain only the 2014 data, which can now be merged. However before these can be merged sucessfully these columns should be renamed so it is easier to idenitify the variables. As a whole, variables can either be renamed indivdiually or as a whole, in this instance they will be renamed as a whole.
